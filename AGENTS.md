...
| -------------- | --------------------- | ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Web app        | `apps/web`            | TanStack Start, React 19, TanStack Router, TanStack Query, Tailwind CSS v4, Vite, Convex client | Owns the local Suno Studio UI and API routes. Uses shared web UI from `@workspace/ui`.                     |
...
| Suno extension | `apps/suno-extension` | Chromium extension, plain TypeScript, popup UI                                                  | Captures Suno, YouTube, Pinterest, and DistroKid browser context for the local Studio app.                 |
...
| Album workflow | `packages/workflow`   | Node.js TypeScript, Remotion, media processing                                                  | Owns Suno imports/downloads, cover generation, video rendering, YouTube uploads, and DistroKid packaging.  |
...
guide first. Do not assume workspace-local skills are globally available by
name.
...
| `apps/mobile`                     | `apps/mobile/AGENTS.md`         | Expo, React Native, native UI, NativeWind, data fetching                    |
| `apps/suno-extension`             | `apps/suno-extension/AGENTS.md` | Suno browser flow, extension popup, YouTube/Pinterest/DistroKid capture     |
...
| `packages/workflow`               | `packages/workflow/AGENTS.md`   | Remotion, Suno downloads/imports, cover generation, YouTube/DistroKid flows |
