...
## Transcribe speech to text
This example application shows how to prompt the Gemini API to transcribe, translate, and summarize speech, including timestamps and emotion detection using structured outputs .
```
from
...
description
=
"List of transcribed segments with timestamp."
,
...
response.json
```
You can prompt AI Studio Build to create an app just like this example transcription app , with the click of a button.
## Input audio
