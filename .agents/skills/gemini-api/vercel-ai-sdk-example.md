...
- On this page
- Prerequisites
- Set up your application Install dependencies Configure your API key
...
For a quick test to ensure everything is set up correctly, add the following code to main.ts . This basic example uses generateText to get a simple response from Gemini.
```
import
...
```
Before adding more complexity, run this script to verify that your environment is configured correctly. Run the following command in your terminal:
```
npx
...
- AI SDK cookbook: Get Started with Gemini