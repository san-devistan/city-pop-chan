# Migrate to the Google Gen AI SDK
- On this page
- Installation
- API access
- Authentication
- Generate content Text Image Streaming
- Configuration
- Safety settings
- Async
- Chat
...
- Search grounding
- JSON response
- Files Upload List and get Delete
- Context caching
- Count tokens
- Generate images
- Embed content
...
```
After
With Google GenAI SDK, you create an API client first, which is used to call the API. The new SDK will pick up your API key from the GEMINI_API_KEY environment variables, if you don't pass one to the client.
```
export
