...
- Add API Development Skills gemini-api-dev gemini-live-api-dev gemini-interactions-api
- Verify installation 1. Verify agent behavior 2. Verify manifestations & tools
- Troubleshooting Agent didn't discover the skill Global vs. local conflict
- Resources
