...
- New API features in Gemini 3 Thinking level Media resolution Temperature Thought signatures Structured Outputs with tools Image generation Code Execution with images Multimodal function responses Combine built-in tools and function calling
...
```
### Media resolution
Gemini 3 introduces granular control over multimodal vision processing using the media_resolution parameter. Higher resolutions improve the model's ability to read fine text or identify small details, but increase token usage and latency. The media_resolution parameter determines the maximum number of tokens allocated per input image or video frame.
...
"I need to calculate the risk step-by-step. First, I'll look at volatility..."
,
...
"I will generate a cyberpunk city..."
,
...
functionResponseMultimodalData
...
3. Is there a free tier for Gemini 3? Gemini 3 Flash gemini-3-flash-preview and 3.1 Flash-Lite gemini-3.1-flash-lite have free tiers in the Gemini API. You can try Gemini 3.1 Pro and 3 Flash for free in Google AI Studio, but there is no free tier available for gemini-3.1-pro-preview in the Gemini API.
...
8. What is gemini-3.1-pro-preview-customtools ? If you are using gemini-3.1-pro-preview and the model ignores your custom tools in favor of bash commands, try the gemini-3.1-pro-preview-customtools model instead. More info here .
## Next steps
