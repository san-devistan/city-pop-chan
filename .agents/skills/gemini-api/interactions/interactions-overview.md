...
- Get started Feature Guides
- How the Interactions API works Access outputs with SDK convenience properties Server-side state management Data storage and retention
- Best practices
...
- Feedback
- What's next
The Interactions API is the new recommended standard for building with Gemini. It is optimized for agentic workflows, server-side state management, and complex multi-modal, multi-turn conversations. The original generateContent API remains fully supported.
## Why use the Interactions API?
...
To learn about the most recent breaking change and understand how to migrate, see Breaking changes migration guide (May 2026) .
...
- Learn about Streaming interactions for real-time response handling.
