...
- Usage info
- File prompting strategies Be specific in your instructions Add a few examples Break it down step-by-step Specify the output format Put your image first for single-image prompts Troubleshooting your multimodal prompt
- What's next
# Files API
...
| Updated prompt | Improved response |
| --- | --- |
| First, count how many toilet paper rolls are in this picture. Then, determine how much toilet paper a typical person uses per day. Calculate how long these rolls of toilet paper will last. | There are 3 rolls of toilet paper in this picture. A typical person uses about 20 sheets of toilet paper per day. If each roll contains 200 sheets, then each roll will last for about 10 days. Therefore, the 3 rolls will last for about a month. |
