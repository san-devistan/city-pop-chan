...
- Limitations
- Optional configurations Output format Aspect ratios and image size
...
- High-resolution output : Built-in generation capabilities for 1K, 2K, and 4K visuals. Gemini 3.1 Flash Image adds the smaller 512px (0.5K) resolution.
- Advanced text rendering : Capable of generating legible, stylized text for infographics, menus, diagrams, and marketing assets.
- Grounding with Google Search : The model can use Google Search as a tool to verify facts and generate imagery based on real-time data (e.g., current weather maps, stock charts, recent events). Gemini 3.1 Flash Image adds the integration of Google Image Search Grounding alongside Web Search.
...
open
(
'/path/to/your/man_in_white_glasses.jpg'
,
...
| --- | --- | --- |
| A blue floral summer dress on a neutral background | Full-body shot of a woman with her hair in a bun... | A woman wearing a blue floral summer dress in an outdoor setting |
...
| Input 1 | Input 2 | Output |
| --- | --- | --- |
| A professional headshot of a woman with brown hair and blue eyes... | Modern brand identifier with letters G and A | Take the first image of the woman with brown hair, blue eyes, and a neutral expression... |
