...
- API methods and parameters Understanding the grounding response Display the Google Maps contextual widget
- Use cases Handling place-specific questions Providing location-based personalization Assisting with itinerary planning
- Service usage requirements Inform the user about the use of Google Maps sources Display Google Maps sources with Google Maps links Google Maps text attribution guidelines Context token, place ID, and review ID Prohibited activity and territory
- Best practices
- Limitations
...
"CanteenM is an American restaurant with..."
...
"https://maps.google.com/?cid=13100894621228039586"
,
...
"places/ChIJ0-zA1vBZwokRon0fGj-6z7U"
...
"CanteenM is an American restaurant with a 4.6-star rating and is open 24 hours."
...
(
f
'<gmp-place-contextual context-token="
{
widget_token
}
...
| Font size | Minimum font size: 12sp Maximum font size: 16sp To learn about sp, see Font size units on the Material Design website . |
| Spacing | Normal |
#### Example CSS
...
Grounding with Google Maps has additional restrictions for certain content and activities to maintain a safe and reliable platform. In addition to the usage restrictions in the Terms :
...
- Model Support: See the Supported models section.
