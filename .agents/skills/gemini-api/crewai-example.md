# Customer support analysis with Gemini and Crew AI
- On this page
...
"crewai[tools]"
```
Set your Gemini API key as an environment variable named GEMINI_API_KEY , then configure CrewAI to use the Gemini model.
```
import
...
# Use the Gemini 3 recommended temperature
...
# This agent focuses on its specific task
...
goal
=
'Identify bottlenecks and inefficiencies in current support processes based on the data analysis. Propose actionable improvements.'
,
...
goal
=
'Compile the analysis and improvement suggestions into a concise, clear, and actionable report for the COO.'
,
...
# Assign task to the data_analyst agent
...
# Assign task to the process_optimizer agent
...
# Assign task to the report_writer agent
...
# Tasks will run sequentially in the order defined
