...
```
## Input method comparison
The following table compares each input method with file limits and best use cases. Note that the file size limit may vary depending on the file type and model/tokenizer used to process the file.
...
- For more guidance on prompt design, like tuning sampling parameters, see the Prompt strategies guide.