...
wiring, server functions, Suno Studio screens, browser-facing API routes, and
...
The web app can orchestrate Suno Studio actions and expose local API routes, but
media processing, file writes, cover generation, video rendering, YouTube
uploads, and DistroKid package creation belong in `packages/workflow`.
...
toolbar comments. Use generated Convex APIs for backend access; provider setup,
